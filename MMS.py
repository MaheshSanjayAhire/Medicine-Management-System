...
class MedicineManagementSystem:
    def __init__(self,root):
        ...
        # ========== Title label======================================================================================
        lbltitle=Label(self.root,text="MEDICINE MANAGEMENT SYSTEM",bg="white",fg="darkblue",bd=15,relief=RIDGE,font=("times new roman",50,"bold"),padx=2,pady=6)
        ...
        DataFrameLeft=LabelFrame(DataFrame,bd=10,padx=20,relief=RIDGE,fg="crimson",
                                                font=("arial",12,"bold"),text="Medicine Information")
        DataFrameLeft.place(x=0,y=5,width=900,height=350)

        lblReg=Label(DataFrameLeft,width=37,font=("arial",15,"bold"),text="Wear A Mask & Stay Safe",fg="red",padx=2,bg="white")
        ...
        # ========MainButtons=======
        btnAddData=Button(ButtonFrame,command=self.add_data,text="ADD MEDICINE",font=("arial",13,"bold"),width=14,bg="darkblue",fg="white")
        btnAddData.grid(row=0,column=0)

        btnUpdateMed=Button(ButtonFrame,command=self.update_data,text="UPDATE",font=("arial",13,"bold"),width=14,bg="darkblue",fg="white")
        btnUpdateMed.grid(row=0,column=1)

        btnDeleteMed=Button(ButtonFrame,command=self.mDelete,text="DELETE",font=("arial",13,"bold"),width=14,bg="crimson",fg="white")
        btnDeleteMed.grid(row=0,column=2)

        btnRestMed=Button(ButtonFrame,command=self.Reset,text="RESET",font=("arial",13,"bold"),width=14,bg="darkblue",fg="white")
        btnRestMed.grid(row=0,column=3)

        btnExitMed=Button(ButtonFrame,command=self.iExit,text="EXIT",font=("arial",13,"bold"),width=14,bg="darkblue",fg="white")
        btnExitMed.grid(row=0,column=4)

        # ==========Search By========
        lblSearch=Label(ButtonFrame,font=("arial",17,"bold"),text="Search By",padx=2,bg="crimson",fg="white")
        ...
        btnExit=Button(ButtonFrame,command=self.search_data,text="SEARCH",font=("arial",12,"bold"),width=14,bg="darkblue",fg="white")
        btnExit.grid(row=0,column=8)

        btnExit=Button(ButtonFrame,command=self.fatch_data,text="SHOW ALL",font=("arial",12,"bold"),width=13,bg="darkblue",fg="white")
...
# ===============================Right Department Management labelframe =============================================================
        ...
        DataFrameRight=LabelFrame(DataFrame,bd=12,padx=20,relief=RIDGE,fg="crimson",
    ...
    # =====================Exit================================================================
    def iExit(self):
        iExit=tkinter.messagebox.askyesno("Medicine Management System","Confirm if you want to exit")
        if iExit>0:
            root.destroy()
            return
...
if __name__ == "__main__":
    root=Tk()
    obj=MedicineManagementSystem(root)
    root.mainloop()
